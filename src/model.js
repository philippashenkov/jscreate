...
const text = `
<a href="https://uicreatorapp.web.app" target="_blank">Доступно на Firebase</a> 
`
...
export const model = [
  ...
  new TextColumnsBlock([
    'Приложение выполнено на чистом JavaScript, без использования библиотек',
    'Использованы принципы SOLID и ООП',
    'Создания пользовательского интерфейса с использованием конструктора классов'
  ], {
